...
class ClosePO(models.Model):
    ...
    #This method will be called when the Close Po button is pressed
    def close_po(self):
        for line in self.order_line:
            if line.po_done == False:
                line.write({'po_done':True})

    #This method the checks and updates state of PO as to whether it is open or not
...
class ClosePoLine(models.Model):
    ...
    #This method computes whether a PO line is open or closed depending on the ordered and recieved qty
